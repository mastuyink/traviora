...
class TCustomer extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_user', 'id_jk', 'no_telp', 'id_tipe_cust', 'total_transaksi', 'total_passenger'], 'integer', 'message' => '{attribute} Must be Number '],
            [['nama_customer', 'no_telp','email'], 'required'],
            [['email'],'email'],
