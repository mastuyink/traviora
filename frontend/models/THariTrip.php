...
class THariTrip extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_destinasi', 'id_jenis_hari_trip', 'id_senin', 'id_selasa', 'id_rabu', 'id_kamis', 'id_jumat', 'id_sabtu', 'id_minggu'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_jenis_hari_trip' => Yii::t('app', 'Id Jenis Hari Trip'),
            'id_senin' => Yii::t('app', 'Id Senin'),
            'id_selasa' => Yii::t('app', 'Id Selasa'),
            'id_rabu' => Yii::t('app', 'Id Rabu'),
            'id_kamis' => Yii::t('app', 'Id Kamis'),
            'id_jumat' => Yii::t('app', 'Id Jumat'),
            'id_sabtu' => Yii::t('app', 'Id Sabtu'),
            'id_minggu' => Yii::t('app', 'Id Minggu'),
