...
class TJemput extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['id_booking'], 'required'],
            [['id_area_jemput', 'id_metode_jemput', 'id_jam_jemput', 'no_telp_jemput', 'lokasi_jemput'], 'integer'],
            [['biaya_jemput'],'number'],
            [['datetime'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'id_booking' => Yii::t('app', 'No Booking'),
            'lokasi'    => Yii::t('app', 'Daerah'),
            'nama_area' => Yii::t('app', 'Lokasi'),
            'id_area_jemput' => Yii::t('app', 'Lokasi Sekitar Jemput'),
            'id_metode_jemput' => Yii::t('app', 'Metode Jemput'),
            'id_jam_jemput' => Yii::t('app', 'Jam Jemput'),
            'alamat_jemput' => Yii::t('app', 'Alamat Jemput'),
            'no_telp_jemput' => Yii::t('app', 'No Telp'),
