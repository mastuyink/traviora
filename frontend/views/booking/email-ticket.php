...
<span style="color:#333333;"></span>
  <br>
<span style="display: inline;">
: <?= $modelBooking->idCustomer->nama_customer ?>
</span><br>
  <span style="display: inline;">
: <?= $modelBooking->idCustomer->email ?>
</span><br>
  <span style="display: inline;">
: <?= $modelBooking->idCustomer->no_telp ?>
</span>
...
<a class="button_blue" href="http://traviora.com/contact" target="_BLANK" style="text-decoration:none;
        background: #FF3421;
        /*font styles*/font-family:HelveticaNeueLight,HelveticaNeue-Light,Helvetica Neue Light,HelveticaNeue,Helvetica,Arial,sans-serif;
        font-weight:300;
        font-stretch:normal;
