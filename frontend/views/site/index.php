        ...
        if ($dataProvider !== null) {
              foreach ($dataProvider as $key => $konten) {
                 ...
                 <div class='panel panel-default' style='min-height:200%;'>
                        <div class='panel-heading' style='min-height:125px; max-height:125px;'><a href='".$konten->idDestinasi->idLokasiDestinasi->lokasi."/".$konten->idDestinasi->idJenisDestinasi->jenis_destinasi."/".$konten->slug."'>".Html::img(['/posting/thumb','id'=>$konten->id],['class'=>'img-responsive', 'width'=>'100%','height'=>'100%'])."</a></div>
                     <ul class='list-group'>
                      <li class='list-group-item'><center>".Html::a($konten->idDestinasi->nama_destinasi,['/posting/view','lokasi'=>$konten->idDestinasi->idLokasiDestinasi->lokasi,'kategori'=>$konten->idDestinasi->idJenisDestinasi->jenis_destinasi,'slug'=>$konten->slug],['class'=>'btn ','style'=>'color:black'])."</center></li>";
