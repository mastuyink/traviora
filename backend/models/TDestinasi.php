...
class TDestinasi extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_lokasi_destinasi' => Yii::t('app', 'Lokasi Trip'),
            'id_jenis_destinasi' => Yii::t('app', 'Jenis Trip'),
            'nama_destinasi' => Yii::t('app', 'Name Of Trip'),
            ...
            'id_jenis_konfirmasi' => Yii::t('app', 'Jenis Konfirmasi'),
